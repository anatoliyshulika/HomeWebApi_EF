        ...
        public ActionResult AddDevice(string modelName, string typeOfDevice)
        {
            ...
            switch (typeOfDevice)
            {
                default:
                    break;
                case "Lamp":
                    Lamp lamp = new Lamp { ViewPath = lampViewPath, Name = name, State = false };
            ...
            case "Radio":
                    Radio radio = new Radio { ViewPath = radioViewPath, Name = modelName, State = false, Volume = SetLevel.Low, CreateTime = DateTime.Now.ToLongTimeString() };
